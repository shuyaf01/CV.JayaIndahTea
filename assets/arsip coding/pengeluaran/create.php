                        ...
                        $(document).ready(function(){
                            ...
                            $('#selectForm2').change(function(){
                                ...
                                <div class="form-group row <?php echo (form_error('nama_produk')) ? ' has-error' : ''; ?>">
                                    <label for="inputNamaBarang" class="col-sm-2 col-form-label">Jenis Pemasukan</label>
                                    <div class="col-sm-10">                                
...
<br><a href="<?php echo site_url('PemasukanController') ?>" class="btn btn-default float-right">&ensp;Batal&ensp;</a>

        ...
        <div class="row">
            <div class="col-lg-12 col-xs-12">
                <div class="box">
                        ...
                        <!-- form start -->
                        <br>
                        <?php echo form_open_multipart(site_url('ProdukController/processCreate')) ?>
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group row ">
                                    <label for="inputIDProduk" class="col-sm-2 col-form-label">ID</label>
                                    <div class="col-sm-10">
                                    <input type="text" class="form-control" name='id_produk' readonly value="<?php echo $new_id; ?>" >    
                                    </div>       
                                </div>
                                ...
                                <div class="form-group row <?php echo (form_error('foto_produk')) ? ' has-error' : ''; ?>">
                                    ...
                                    Format file jpg, jpeg, gif dan png
